...
const config = {
	...
	entry: {
		...
		'post-type': ['./src/js/post-type/post-type.js'],
		'media-uploader': ['./src/js/utils/media-uploader.js'],
		'frontend': ['./src/js/utils/frontend.js'],
		// Styles should be separated by comma
		'styles': [
			'./src/scss/app.scss',
			'./src/scss/post-type.scss',
			'./src/scss/media-uploader.scss',
 		]
	},
