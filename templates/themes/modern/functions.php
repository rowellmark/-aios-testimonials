...
if ( !class_exists( 'aios_testimonials_details_page_template_modern' ) ) {

	class aios_testimonials_details_page_template_modern{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_TESTIMONIALS_URL . 'templates/themes/modern';
			$this->active_template_dir = AIOS_TESTIMONIALS_DIR . '/templates/themes/modern';
			$this->add_actions();
...
$aios_testimonials_details_page_template_modern = new aios_testimonials_details_page_template_modern();