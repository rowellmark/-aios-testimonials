...
if ( !class_exists( 'aios_testimonials_details_page_template_classic' ) ) {

	class aios_testimonials_details_page_template_classic{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_TESTIMONIALS_URL . 'templates/themes/classic';
			$this->active_template_dir = AIOS_TESTIMONIALS_DIR . '/templates/themes/classic';
			$this->add_actions();
		}
		...
		public function custom_archive( $template ) {
			...
			if ( $main_page == get_the_ID() && get_the_ID() != 0  ) {
				if ($main_page == get_the_ID() && get_the_ID() != 0) {
					...
					}else if($testimonials_source === 'BridgeAPI'){
						$template = $this->active_template_dir . '/archive-bridge.php';
					} else {
...
$aios_testimonials_details_page_template_classic = new aios_testimonials_details_page_template_classic();