...
if ( !class_exists( 'aios_testimonials_details_page_template_minimalist' ) ) {

	class aios_testimonials_details_page_template_minimalist{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_TESTIMONIALS_URL . 'templates/themes/minimalist';
			$this->active_template_dir = AIOS_TESTIMONIALS_DIR . '/templates/themes/minimalist';
			$this->add_actions();
		}
...
$aios_testimonials_details_page_template_minimalist = new aios_testimonials_details_page_template_minimalist();